...
// Lista de estudiantes de Noveno A → Décimo
$studentsToEnroll = [
    'Diana Lisseth Coronado Hernandez',
    'Laura Valentina Garcia Garcia',
    'Diego Stiven Garcia Ortigoza',
    'Nicolas Leal Ortigoza',
    'Valentina Serrato Rodriguez',
    'Elkin Estiven Garcia Mayorga',
];

echo "===========================================\n";
echo "   MATRÍCULA AUTOMÁTICA - AÑO 2026\n";
echo "   Noveno A → Décimo\n";
echo "   Sede: Santa Ana\n";
echo "===========================================\n\n";
...
foreach ($studentsToEnroll as $name) {
    ...
    try {
        ...
        echo "✓ MATRICULADO: " . $student->name . " → Décimo\n";
        $enrolled++;
    } catch (Exception $e) {
