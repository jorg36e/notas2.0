<x-filament-panels::page.simple>
    @php
        ...
        $panelTitle = $settings['login_student_title'] ?? 'Portal Estudiante';
        $panelSubtitle = $settings['login_student_subtitle'] ?? 'Consulta tus notas y boletines';
    @endphp
    ...
    <style>
        ...
        * { box-sizing: border-box; }
        ...
        .hero-bg-overlay {
            position: absolute;
            inset: 0;
            background: linear-gradient(135deg, rgba(109, 40, 217, 0.93) 0%, rgba(124, 58, 237, 0.88) 50%, rgba(139, 92, 246, 0.85) 100%);
        }
        ...
        .card-body .fi-btn-primary:hover {
            ...
            box-shadow: 0 12px 35px -10px rgba(124, 58, 237, 0.5) !important;
        }
