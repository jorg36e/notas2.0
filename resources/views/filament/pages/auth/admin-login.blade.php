    ...
    <style>
        ...
        * { box-sizing: border-box; }
        ...
        .hero-bg-overlay {
            position: absolute;
            inset: 0;
            background: linear-gradient(135deg, rgba(30, 64, 175, 0.93) 0%, rgba(37, 99, 235, 0.88) 50%, rgba(59, 130, 246, 0.85) 100%);
        }
        ...
        .card-body .fi-btn-primary {
            ...
            box-shadow: 0 8px 25px -8px rgba(37, 99, 235, 0.4) !important;
            transition: all 0.3s cubic-bezier(0.4, 0, 0.2, 1) !important;
        }
        
        .card-body .fi-btn-primary:hover {
            transform: translateY(-2px);
            box-shadow: 0 12px 35px -10px rgba(37, 99, 235, 0.5) !important;
        }
